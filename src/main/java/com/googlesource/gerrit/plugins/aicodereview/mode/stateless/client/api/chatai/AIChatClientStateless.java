...
@Slf4j
@Singleton
public class AIChatClientStateless extends AIChatClient implements IChatAIClient {
    ...
    private String createRequestBody(Configuration config, ChangeSetData changeSetData, String patchSet) {
        AIAIChatPromptStateless AIChatPromptStateless = new AIAIChatPromptStateless(config, isCommentEvent);
