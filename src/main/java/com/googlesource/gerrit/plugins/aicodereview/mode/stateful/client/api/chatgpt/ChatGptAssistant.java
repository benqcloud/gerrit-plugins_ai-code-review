...
import static com.googlesource.gerrit.plugins.aicodereview.mode.common.client.prompt.AIChatPromptFactory.getChatGptPromptStateful;
...
public class ChatGptAssistant extends ClientBase {
    ...
    private Request createRequest(String vectorStoreId) {
        ...
        ChatGptCreateAssistantRequestBody requestBody = ChatGptCreateAssistantRequestBody.builder()
                .name(AIChatGptPromptStatefulBase.DEFAULT_GPT_ASSISTANT_NAME)
